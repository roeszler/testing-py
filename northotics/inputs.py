...
"""
from northotics.manipulation import delete_blank_space
from northotics.store import user_data, order_data
from northotics.validation import (
    verify_user_f_name, verify_user_l_name, verify_user_email
    )
...
def get_size_data():
    ...
    while True:
        try:
            size_eu = float(delete_blank_space(input(
...
def get_height_data():
    ...
    """
    height = delete_blank_space(input(
...
def get_width_data():
    ...
    order_data
    """
    width = delete_blank_space(input(
...
def input_order_no():
    ...
    while True:
        try:
            order_no = int(delete_blank_space(input('You Order Number: ')))
